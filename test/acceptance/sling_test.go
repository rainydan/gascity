...
func TestSling_NoArgs_ReturnsError(t *testing.T) {
...
func TestSling_TooManyArgs_ReturnsError(t *testing.T) {
	c := helpers.NewCity(t, testEnv)
	c.Init("claude")
...
func TestSling_InvalidMergeStrategy_ReturnsError(t *testing.T) {
	c := helpers.NewCity(t, testEnv)
	c.Init("claude")
...
func TestSling_OwnedWithNoConvoy_ReturnsError(t *testing.T) {
	c := helpers.NewCity(t, testEnv)
	c.Init("claude")
...
func TestSling_StdinRequiresOneArg_ReturnsError(t *testing.T) {
	c := helpers.NewCity(t, testEnv)
	c.Init("claude")
...
func TestSling_NonexistentAgent_ReturnsError(t *testing.T) {
	c := helpers.NewCity(t, testEnv)
	c.Init("claude")
...
func TestSling_InlineTextWithoutTarget_ReturnsError(t *testing.T) {
	c := helpers.NewCity(t, testEnv)
	c.Init("claude")
...
func TestSling_DryRun_InlineText_ShowsPreview(t *testing.T) {
	c := helpers.NewCity(t, testEnv)
	c.InitFrom(filepath.Join(helpers.ExamplesDir(), "gastown"))

	// Find an agent name from the gastown config.
...
func TestSling_DryRun_Formula_ShowsPreview(t *testing.T) {
	c := helpers.NewCity(t, testEnv)
	c.InitFrom(filepath.Join(helpers.ExamplesDir(), "gastown"))
